...
class ModelArguments:
    ...
    attn_implementation: Optional[Literal["eager", "sdpa", "flash_attention_2", "flex_attention"]] = field(
...
class TrainingArguments:
    ...
    # )
    ckpt_manager: Literal["bytecheckpoint", "dcp", "native"] = field(
        default="bytecheckpoint",
        metadata={"help": "Checkpoint manager."},
    )
    ...
    def compute_train_steps(
        ...
        if self.rmpad or self.rmpad_with_pos_ids:
            ...
            self._train_steps = math.floor(dataset_length / self.global_batch_size)
